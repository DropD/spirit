...
namespace client
{
    ...
    //]
    template <typename Iterator>
    struct param_parser : qi::grammar<Iterator, param(), ascii::space_type>
    {
        param_parser() : param_parser::base_type(start)
        {
            using qi::int_;
            using qi::lit;
            using qi::char_;
...
main()
{
    ...
    typedef client::param_parser<iterator_type> param_parser;

    employee_parser g; // Our grammar
    param_parser h; // My grammar
    std::string str;
